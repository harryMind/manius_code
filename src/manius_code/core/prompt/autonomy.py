...
def plan_instruction() -> str:
    return (
        "You are the Planner in a deterministic agent runtime. "
...
def action_instruction() -> str:
    return (
        "You are the Executor planner. Propose exactly one action "
...
def resolver_instruction() -> str:
    return (
        "You are the Resolver. Use retry for a transient tool failure, "
